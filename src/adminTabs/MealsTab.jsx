...
saveMealToCloud, saveFoodCache, deleteFoodCache, getMeals,
...
<option value="g">g</option><option value="ml">ml</option><option value="quả">quả</option><option value="hộp">hộp</option><option value="lát">lát</option><option value="bát">bát</option><option value="muỗng">muỗng</option>
</select>
