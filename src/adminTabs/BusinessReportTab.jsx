...
export function BusinessReportTab({ isAdmin }) {
  ...
  return (
    <div style={{ ...card, maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ fontSize: 20, fontWeight: 800, color: C.t1, marginBottom: 4 }}>Báo cáo kinh doanh</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 16 }}>
        <div style={{ background: C.surface, borderRadius: 12, border: `1px solid ${C.border}`, padding: 14 }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: C.t1, marginTop: 4 }}>{fmtVND(stats.total_revenue)}</div>
        </div>
        <div style={{ background: C.surface, borderRadius: 12, border: `1px solid ${C.border}`, padding: 14 }}>
        ...
        <div style={{ background: C.surface, borderRadius: 12, border: `1px solid ${C.border}`, padding: 14 }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: C.primary, marginTop: 4 }}>{stats.premium_count}</div>
        </div>
        <div style={{ background: C.surface, borderRadius: 12, border: `1px solid ${C.border}`, padding: 14 }}>
          <div style={{ fontSize: 12, color: C.t2, fontWeight: 600 }}>Tỷ lệ chuyển đổi</div>
          <div style={{ fontSize: 22, fontWeight: 800, color: C.t1, marginTop: 4 }}>{conversionRate}%</div>
        </div>
      </div>
      ...
      <div style={{ background: C.goldBg, borderRadius: 12, border: `1px solid #FDE68A`, padding: 14, marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 22, fontWeight: 800, color: "#92400E", marginTop: 4 }}>{inactiveTotal} user</div>
      </div>

      <div style={{ background: C.surface, borderRadius: 12, border: `1px solid ${C.border}`, padding: "16px 18px", marginBottom: 16 }}>
        <div style={{ fontSize: 14, fontWeight: 800, color: C.t1, marginBottom: 12 }}>Doanh thu 6 tháng gần nhất</div>
        <div style={{ position: "relative", width: "100%", height: 200 }}><canvas ref={revCanvasRef}/></div>
      </div>

      <div style={{ background: C.surface, borderRadius: 12, border: `1px solid ${C.border}`, padding: "16px 18px", marginBottom: 16 }}>
        <div style={{ fontSize: 14, fontWeight: 800, color: C.t1, marginBottom: 10 }}>Phân bổ user theo gói</div>
        <div style={{ display: "flex", gap: 16, marginBottom: 10, fontSize: 12, color: C.t2, fontWeight: 600 }}>
