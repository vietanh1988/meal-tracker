...
{"items":[{"name":"tên","gram":số,"protein":số,"carb":số,"fat":số,"fiber":số,"cal":số}],"tip":"1 câu gợi ý cho người gym"}`;
  ...
  return <div>
    {!hidePills&&!forcedSection&&<div style={{display:"flex",gap:6,marginBottom:16,flexWrap:"wrap"}}>
      {[{id:"meals",l:"🍽️ Bữa ăn"},...(isAdmin?[{id:"ai",l:"🤖 Kết nối AI"},{id:"admin",l:"🔧 Quản lý version"},{id:"templates",l:"📚 Mẫu"},{id:"food_cache_pending",l:`🗂️ Kho món${pendingCount>0?` (${pendingCount})`:""}`},{id:"food_db",l:"🗄️ Kho thực phẩm"}]:[]),{id:"profile",l:"👤 Hồ sơ"},{id:"weight",l:"⚖️ Cân nặng"}].map(s=>
    ...
    {!hidePills&&mob&&forcedSection==="settings"&&!initialSection&&section===null&&<div>
      ...
      <div style={{background:C.card,borderRadius:14,border:`1.5px solid ${C.border}`,overflow:"hidden"}}>
        {[
          ...
          {id:"food_db",t:"Kho thực phẩm",svg:<svg viewBox="0 0 96 96" width={18} height={18}><defs><linearGradient id="lfd1" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#40C8FF"/><stop offset="55%" stopColor="#0050FF"/><stop offset="100%" stopColor="#DC2626"/></linearGradient></defs><ellipse cx="48" cy="24" rx="36" ry="14" fill="url(#lfd1)"/><path d="M12 24 v20 c0 8 16 14 36 14 s36-6 36-14 v-20" fill="none" stroke="url(#lfd1)" strokeWidth="4"/><path d="M12 44 v20 c0 8 16 14 36 14 s36-6 36-14 v-20" fill="none" stroke="url(#lfd1)" strokeWidth="4" opacity="0.6"/></svg>},
        ].map((s,i,arr)=>
