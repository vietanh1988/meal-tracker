  ...
  return <div>
    ...
    {!hidePills&&mob&&forcedSection==="settings"&&!initialSection&&section===null&&<div>
      ...
      <div style={{background:C.card,borderRadius:14,border:`1.5px solid ${C.border}`,overflow:"hidden",marginBottom:20}}>
        {[
          {id:"diary",t:"Nhật ký bữa ăn",svg:<svg viewBox="0 0 96 96" width={18} height={18}><defs><linearGradient id="ld1" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#40C8FF"/><stop offset="100%" stopColor="#0050FF"/></linearGradient></defs><rect x="12" y="6" width="72" height="84" rx="10" fill="url(#ld1)"/><rect x="24" y="22" width="48" height="6" rx="3" fill="white" opacity="0.85"/><rect x="24" y="36" width="36" height="6" rx="3" fill="white" opacity="0.6"/><rect x="24" y="50" width="42" height="6" rx="3" fill="white" opacity="0.6"/><rect x="24" y="64" width="28" height="6" rx="3" fill="white" opacity="0.4"/></svg>},
