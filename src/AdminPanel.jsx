...
export function AdminPanel({weightLog,setWeightLog,addWeight,deleteWeight,resetWeights,profile,setProfile,macro,saveMealToCloud,saveFoodCache,deleteFoodCache,getMeals,foodCache,appSettings,isAdmin,saveSetting,forcedSection,signOut,user,weeklyTemplates,saveWeeklyTemplate,getWeeklyTemplate,deleteWeeklyTemplate,defaultTemplates,saveDefaultTemplate,deleteDefaultTemplate,applyTemplate,refreshDefaultTemplates,weeklyBundles,saveWeeklyBundle,deleteWeeklyBundle,refreshWeeklyBundles,initialSection,hidePills,getMealHistory,getDailyLogs}){if(!profile||!macro)return null;
  ...
  return <div>
    ...
    {!hidePills&&!mob&&forcedSection==="settings"&&<div style={{display:"flex",borderBottom:`2px solid ${C.border}`,marginBottom:16,overflowX:"auto",WebkitOverflowScrolling:"touch",scrollbarWidth:"none",msOverflowStyle:"none"}}>
      {[{id:"profile",t:"Hồ sơ",svg:<svg viewBox="0 0 96 96" width={14} height={14}><defs><linearGradient id="pp1" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#40C8FF"/><stop offset="100%" stopColor="#0050FF"/></linearGradient></defs><circle cx="48" cy="30" r="24" fill="url(#pp1)"/><path d="M4 96 C4 60 92 60 92 96 Z" fill="url(#pp1)"/></svg>},
        ...
        {id:"report",t:"Báo cáo",svg:<svg viewBox="0 0 96 96" width={14} height={14}><defs><linearGradient id="pd1" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#40C8FF"/><stop offset="100%" stopColor="#0050FF"/></linearGradient></defs><rect x="8" y="56" width="22" height="32" rx="5" fill="url(#pd1)"/><rect x="37" y="36" width="22" height="52" rx="5" fill="url(#pd1)"/><rect x="66" y="16" width="22" height="72" rx="5" fill="url(#pd1)"/><rect x="4" y="90" width="88" height="6" rx="3" fill="url(#pd1)"/></svg>},
        ...
        {id:"feedback_inline",t:"Góp ý & Báo lỗi",svg:<svg viewBox="0 0 96 96" width={14} height={14}><defs><linearGradient id="pi7" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#40C8FF"/><stop offset="100%" stopColor="#0050FF"/></linearGradient></defs><rect x="6" y="12" width="84" height="60" rx="14" fill="url(#pi7)"/><path d="M24 72 L24 84 L42 72" fill="url(#pi7)"/><circle cx="30" cy="42" r="6" fill="white" opacity="0.9"/><circle cx="48" cy="42" r="6" fill="white" opacity="0.9"/><circle cx="66" cy="42" r="6" fill="white" opacity="0.9"/></svg>},
    ...
    {!hidePills&&mob&&forcedSection==="settings"&&!initialSection&&section===null&&<div>
      ...
      <div style={{background:C.card,borderRadius:14,border:`1.5px solid ${C.border}`,overflow:"hidden",marginBottom:20}}>
        {[
          ...
          {id:"report",t:"Báo cáo",svg:<svg viewBox="0 0 96 96" width={18} height={18}><defs><linearGradient id="lr1" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#40C8FF"/><stop offset="100%" stopColor="#0050FF"/></linearGradient></defs><rect x="8" y="56" width="22" height="32" rx="5" fill="url(#lr1)"/><rect x="37" y="36" width="22" height="52" rx="5" fill="url(#lr1)"/><rect x="66" y="16" width="22" height="72" rx="5" fill="url(#lr1)"/><rect x="4" y="90" width="88" height="6" rx="3" fill="url(#lr1)"/></svg>},
          ...
          ...(!isAdmin?[{id:"feedback_inline",t:"Góp ý & Báo lỗi",svg:<svg viewBox="0 0 96 96" width={18} height={18}><defs><linearGradient id="li7" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#40C8FF"/><stop offset="100%" stopColor="#0050FF"/></linearGradient></defs><rect x="6" y="12" width="84" height="60" rx="14" fill="url(#li7)"/><path d="M24 72 L24 84 L42 72" fill="url(#li7)"/><circle cx="30" cy="42" r="6" fill="white" opacity="0.9"/><circle cx="48" cy="42" r="6" fill="white" opacity="0.9"/><circle cx="66" cy="42" r="6" fill="white" opacity="0.9"/></svg>}]:[]),
        ].map((s,i,arr)=>
    ...
    {section==="feedback_inline"&&<FeedbackTab user={user} isAdmin={isAdmin}/>}

    {section==="diary"&&<DiaryTab userId={user?.id} macro={macro}/>}

    {section==="report"&&<ReportView weightLog={weightLog} profile={profile} macro={macro} getMealHistory={getMealHistory} getDailyLogs={getDailyLogs} appSettings={appSettings} mob={mob}/>}
