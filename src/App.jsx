            ...
            <div style={{...card,padding:20}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}><span style={{fontSize:15,fontWeight:800,color:C.t1}}>Danh sách thực đơn</span><span onClick={()=>setTab("meals")} style={{fontSize:12,color:C.primary,fontWeight:700,cursor:"pointer"}}>Xem tất cả →</span></div>
              {(() => {
                ...
                return <>
                  ...
                  {allEaten && pcCalOk && <div style={{textAlign:"center",padding:"20px 16px",background:"linear-gradient(135deg,#FFF7ED,#FEF3C7,#FDE68A)",borderRadius:16,border:"1.5px solid #F59E0B",marginBottom:6,position:"relative",overflow:"hidden"}}>
                    ...
                    <div style={{fontSize:12,color:"#B45309",marginTop:4,fontWeight:600,position:"relative"}}>Đã ăn đủ {eatenCount}/{pcWithItems.length} bữa · {pcAC.toLocaleString()} / {pcHCal.toLocaleString()} kcal</div>
                  ...
                  {allEaten && !pcCalOk && <>
                    <div style={{textAlign:"center",padding:"16px",background:"linear-gradient(135deg,#EFF6FF,#DBEAFE)",borderRadius:16,border:"1.5px solid #93C5FD",marginBottom:6,position:"relative",overflow:"hidden"}}>
                      ...
                      <div style={{fontSize:15,fontWeight:900,color:"#1E40AF",position:"relative"}}>Đã hoàn thành {eatenCount}/{pcWithItems.length} bữa ăn!</div>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:8,padding:"10px 12px",background:"#FEF3C7",borderRadius:10,border:"1px solid #FDE68A",marginBottom:6}}>
                      ...
                      <div style={{flex:1}}>
                        <div style={{fontSize:12,fontWeight:700,color:"#92400E"}}>Vẫn còn thiếu {pcCalShort > 0 ? pcCalShort : 0} kcal so với mục tiêu</div>
