  ...
  return <div>
    ...
    <div style={{...card,padding:mob?"16px":"24px",border:`1.5px solid ${C.border}`}}>
      ...
      <div style={{display:"flex",alignItems:"baseline",gap:8}}>
        ...
        <div style={{fontSize:mob?14:16,fontWeight:700,color:C.t3}}>/ {heroCal.toLocaleString()} kcal{(profile.calorieMode||"standard")==="asian"&&<span style={{fontSize:12,fontWeight:700,color:"#007AFF",marginLeft:8,padding:"2px 8px",background:"rgba(0,122,255,0.08)",borderRadius:6}}>🇻🇳 Calo chuẩn Việt Nam</span>}{profile.goalType==="cut"&&(profile.dietStrategy||"balanced")!=="balanced"&&<span style={{fontSize:12,fontWeight:700,color:(profile.dietStrategy==="keto"?"#F87171":"#FBBF24"),marginLeft:6,padding:"2px 8px",background:(profile.dietStrategy==="keto"?"rgba(248,113,113,0.12)":"rgba(251,191,36,0.12)"),borderRadius:6}}>🥗 {profile.dietStrategy==="keto"?"Keto":"Low-carb"}</span>}</div>
      </div>
