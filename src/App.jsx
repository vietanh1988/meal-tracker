...
export default function App(){
  ...
  return <div style={{fontFamily:"'Inter',Roboto,-apple-system,'Segoe UI',sans-serif",display:"flex",minHeight:"100vh",background:C.bg,color:C.t1}}>
    ...
    <nav style={{width:220,background:"#fff",borderRight:`1px solid ${C.border}`,position:"fixed",top:0,left:0,bottom:0,zIndex:10,display:"flex",flexDirection:"column",padding:"20px 0",overflowY:"auto"}}>
      ...
      {(()=>{
        const items=[
          {id:"diary_s",l:"Nhật ký bữa ăn",svg:(a)=><svg viewBox="0 0 96 96" width={17} height={17}><defs><linearGradient id="sid" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor={a?"#40C8FF":"#64748B"}/><stop offset="100%" stopColor={a?"#0050FF":"#64748B"}/></linearGradient></defs><rect x="12" y="6" width="72" height="84" rx="10" fill="url(#sid)"/><rect x="24" y="22" width="48" height="6" rx="3" fill="white" opacity="0.85"/><rect x="24" y="36" width="36" height="6" rx="3" fill="white" opacity="0.6"/><rect x="24" y="50" width="42" height="6" rx="3" fill="white" opacity="0.6"/><rect x="24" y="64" width="28" height="6" rx="3" fill="white" opacity="0.4"/></svg>},
