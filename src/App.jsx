        ...
        {tab==="dashboard"&&<div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"55fr 45fr",gap:24}}>
            ...
            <div>
              ...
              <div style={{...card,padding:18}}><ReportView weightLog={weightLog} profile={profile} macro={macro} getMealHistory={getMealHistory} getDailyLogs={getDailyLogs} appSettings={appSettings} mob={false}/></div>
            </div>
          </div>
