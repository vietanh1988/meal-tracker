        ...
        {tab==="dashboard"&&<div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"55fr 45fr",gap:24}}>
            ...
            <div>
              ...
              <div style={{...card,padding:18,maxHeight:480,overflowY:"auto"}}><ReportView weightLog={weightLog} profile={profile} macro={macro} getMealHistory={getMealHistory} getDailyLogs={getDailyLogs} appSettings={appSettings} mob={false}/></div>
            </div>
          </div>
