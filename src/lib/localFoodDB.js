...
export const LOCAL_FOODS = {
  ...
  "cá ngừ": {p:23.4, c:0, f:5.0, cal:144, fiber:0, form:"raw", cat:"seafood"},
  ...
  "tôm tươi": {p:20.3, c:0.2, f:0.5, cal:85, fiber:0, form:"raw", cat:"seafood"},
  ...
  "yến mạch": {p:13.2, c:67.7,f:6.5, cal:379, fiber:10.1,form:"dry", cat:"starch"},
  "bột yến mạch": {p:13.2, c:67.7,f:6.5, cal:379, fiber:10.1,form:"dry", cat:"starch"},
  ...
  "canh sườn":       {p:3.5, c:2.0, f:2.0, cal:42, fiber:0.3, form:"composite", cat:"veg", region:"vn", complexity:2, convenience:5},
  ...
  "canh cá":         {p:4.0, c:2.0, f:1.5, cal:38, fiber:0.3, form:"composite", cat:"veg", region:"vn", complexity:1, convenience:5},
  "lẩu bò":          {p:5.0, c:3.0, f:2.5, cal:55, fiber:0.5, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:6},
  "lẩu gà":          {p:5.0, c:2.0, f:2.0, cal:48, fiber:0.3, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:6},
  "lẩu mắm":         {p:4.5, c:3.0, f:2.0, cal:48, fiber:0.5, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:5},
  ...
  "lẩu mắm miền tây":{p:5.0, c:3.0, f:2.5, cal:55, fiber:0.5, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:5},
  "canh chua miền tây":{p:4.0, c:4.0, f:1.0, cal:42, fiber:0.5, form:"composite", cat:"veg", region:"vn", complexity:2, convenience:5},
  ...
  "canh tôm":        {p:4.0, c:2.0, f:1.0, cal:34, fiber:0.3, form:"composite", cat:"veg", region:"vn", complexity:1, convenience:6},
  "canh ngao":       {p:5.0, c:2.0, f:0.5, cal:33, fiber:0.3, form:"composite", cat:"veg", region:"vn", complexity:1, convenience:6},
  "canh xương":      {p:3.0, c:2.0, f:2.0, cal:38, fiber:0.3, form:"composite", cat:"veg", region:"vn", complexity:2, convenience:5},
  ...
  "lẩu cá":          {p:5.0, c:2.0, f:1.5, cal:42, fiber:0.3, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:5},
  "lẩu riêu cua":    {p:4.0, c:3.0, f:2.0, cal:46, fiber:0.5, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:5},
  "lẩu dê":          {p:6.0, c:3.0, f:2.0, cal:55, fiber:0.5, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:5},
  ...
  "canh hến":        {p:4.0, c:2.0, f:0.5, cal:30, fiber:0.3, form:"composite", cat:"veg", region:"vn", complexity:1, convenience:5},
  "sup gà":          {p:3.0, c:5.0, f:1.0, cal:42, fiber:0.5, form:"composite", cat:"veg", region:"vn", complexity:1, convenience:7},
  ...
  "lẩu mắm cá linh":{p:5.0, c:3.0, f:2.0, cal:50, fiber:0.5, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:5},
  "bún nước lèo":    {p:4.5, c:8.0, f:2.0, cal:68, fiber:0.4, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:6},
  "canh chua cá lóc": {p:4.5, c:4.0, f:1.0, cal:44, fiber:0.5, form:"composite", cat:"veg", region:"vn", complexity:2, convenience:5},
  ...
  "lẩu tomyum":      {p:4.0, c:5.0, f:2.0, cal:55, fiber:0.5, form:"composite", cat:"starch", region:"intl", complexity:2, convenience:7},
  "lẩu cá kèo":     {p:5.0, c:2.0, f:1.5, cal:42, fiber:0.5, form:"composite", cat:"starch", region:"vn", complexity:2, convenience:5},
  "lẩu bò nhúng dấm":{p:6.0, c:3.0, f:2.0, cal:55, fiber:0.5, form:"composite", cat:"starch", region:"vn", complexity:1, convenience:6},
  ...
  "cua đồng nấu canh":{p:3.0, c:2.0, f:1.0, cal:30, fiber:0.5, form:"composite", cat:"veg", region:"vn", complexity:2, convenience:4},
  ...
  "sup cua":         {p:4.0, c:8.0, f:2.0, cal:65, fiber:0.5, form:"composite", cat:"veg", region:"vn", complexity:2, convenience:7},
  "sup măng cua":    {p:4.0, c:6.0, f:1.5, cal:55, fiber:1.0, form:"composite", cat:"veg", region:"vn", complexity:2, convenience:7},
...
// ============================================================
// UNIT_MAP — đơn vị khẩu phần phổ biến (gram per unit)
// PhotoMacroChecker + MealsTab dùng cho dropdown "Chọn nhanh"
// Code cũ không đọc field này → không phá gì
// ============================================================
export const UNIT_MAP = {
  ...
  "cơm gạo lứt":    [{name:"chén nhỏ", gram:100}, {name:"chén vừa", gram:150}],
  "xôi trắng":      [{name:"nắm nhỏ", gram:100}, {name:"nắm vừa", gram:150}],

  // Phở/bún/mì (composite)
  "phở bò":          [{name:"tô nhỏ", gram:300}, {name:"tô vừa", gram:400}, {name:"tô lớn", gram:500}],
  "phở gà":          [{name:"tô nhỏ", gram:300}, {name:"tô vừa", gram:400}, {name:"tô lớn", gram:500}],
  "bún bò huế":      [{name:"tô nhỏ", gram:350}, {name:"tô vừa", gram:450}, {name:"tô lớn", gram:550}],
  "bún riêu":        [{name:"tô nhỏ", gram:300}, {name:"tô vừa", gram:400}],
  "bún chả":         [{name:"suất nhỏ", gram:300}, {name:"suất vừa", gram:400}],
  "hủ tiếu nam vang":[{name:"tô nhỏ", gram:300}, {name:"tô vừa", gram:400}],
  "mì quảng":        [{name:"tô nhỏ", gram:300}, {name:"tô vừa", gram:400}],

  // Cơm phần
  "cơm tấm":         [{name:"đĩa nhỏ", gram:300}, {name:"đĩa vừa", gram:400}, {name:"đĩa lớn", gram:500}],
  "cơm tấm sườn bì chả":[{name:"đĩa nhỏ", gram:350}, {name:"đĩa vừa", gram:400}],
  "cơm gà":          [{name:"đĩa nhỏ", gram:300}, {name:"đĩa vừa", gram:400}],
  "cơm sườn":        [{name:"đĩa nhỏ", gram:300}, {name:"đĩa vừa", gram:400}],
  "cơm bình dân":    [{name:"suất", gram:400}],
  "cơm hộp":         [{name:"hộp", gram:350}],

  // Bánh
  "bánh mì":         [{name:"ổ nhỏ", gram:80}, {name:"ổ vừa", gram:120}, {name:"ổ lớn", gram:180}],
  "bánh mì thịt":    [{name:"ổ", gram:200}],
  "bánh cuốn":       [{name:"đĩa nhỏ", gram:150}, {name:"đĩa vừa", gram:250}],
  "bánh xèo":        [{name:"cái nhỏ", gram:120}, {name:"cái lớn", gram:200}],
  "bánh bao":        [{name:"cái nhỏ", gram:80}, {name:"cái lớn", gram:120}],
  "bánh chưng":      [{name:"miếng", gram:100}, {name:"góc", gram:200}],
  "gỏi cuốn":       [{name:"cuốn", gram:60}],

  // Canh
  "canh bí đỏ":      [{name:"bát nhỏ", gram:150}, {name:"bát vừa", gram:200}, {name:"bát lớn", gram:300}],
  "canh chua cá":    [{name:"bát nhỏ", gram:150}, {name:"bát vừa", gram:200}],
  "canh rau ngót":   [{name:"bát", gram:200}],

  // Thịt/cá (portion)
  "ức gà nướng":     [{name:"miếng nhỏ", gram:100}, {name:"miếng vừa", gram:150}, {name:"miếng lớn", gram:200}],
  "ức gà luộc":      [{name:"miếng", gram:150}],
  "thịt kho":        [{name:"miếng", gram:50}, {name:"phần", gram:100}],
  "cá kho tộ":       [{name:"khúc nhỏ", gram:80}, {name:"khúc vừa", gram:120}],
  "sườn nướng":      [{name:"miếng", gram:80}, {name:"2 miếng", gram:160}],

  // Trái cây
  "chuối":           [{name:"quả nhỏ", gram:80}, {name:"quả vừa", gram:120}, {name:"quả lớn", gram:150}],
  "táo":             [{name:"quả nhỏ", gram:120}, {name:"quả vừa", gram:180}],
  "cam":             [{name:"quả nhỏ", gram:100}, {name:"quả vừa", gram:150}],
  "xoài":            [{name:"quả nhỏ", gram:150}, {name:"quả vừa", gram:250}],
  "bưởi":            [{name:"múi", gram:40}, {name:"nửa quả", gram:200}],
  "dưa hấu":        [{name:"miếng", gram:150}, {name:"2 miếng", gram:300}],
  "thanh long":      [{name:"quả nhỏ", gram:200}, {name:"quả lớn", gram:350}],
  "ổi":              [{name:"quả", gram:150}],
  "quả bơ":          [{name:"nửa quả", gram:75}, {name:"quả", gram:150}],

  // Sữa/đồ uống
  "sữa tươi":       [{name:"hộp nhỏ", gram:180}, {name:"ly", gram:250}],
  "sữa chua":       [{name:"hộp", gram:100}],
  "sữa đậu nành":   [{name:"ly", gram:250}],

  // Lạc/mè (fat filler)
  "lạc":             [{name:"nắm nhỏ", gram:15}, {name:"nắm", gram:25}],
  "đậu phộng":       [{name:"nắm nhỏ", gram:15}, {name:"nắm", gram:25}],
  "mè":              [{name:"thìa", gram:8}, {name:"2 thìa", gram:15}],
  "vừng":            [{name:"thìa", gram:8}, {name:"2 thìa", gram:15}],

  // Chè/dessert
  "chè đậu xanh":   [{name:"bát nhỏ", gram:150}, {name:"bát vừa", gram:250}],
  "bánh flan":       [{name:"cái", gram:100}],
